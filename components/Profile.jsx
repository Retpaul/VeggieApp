...
export default function Profile() {
  return (
    <div className="relative w-fit flex flex-col gap-5 font-itim justify-center ml-8">
      <div className="absolute h-[230px] w-20 rounded-[36px] bg-[#797652] -top-12 -left-20" />
